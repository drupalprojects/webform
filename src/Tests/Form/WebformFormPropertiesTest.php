...
class WebformFormPropertiesTest extends WebformTestBase {
  ...
  public function testProperties() {
    ...
    $this->assertRaw('<form class="webform-submission-test-form-properties-add-form webform-submission-form test-form-properties js-webform-details-toggle webform-details-toggle" invalid="invalid" style="border: 10px solid red; padding: 1em;" data-drupal-selector="webform-submission-test-form-properties-add-form" action="https://www.google.com/search" method="get" id="webform-submission-test-form-properties-add-form" accept-charset="UTF-8">');
...
'prefix': 'Form prefix TEST'",
    ...
    $this->assertRaw('<form class="webform-submission-test-form-properties-add-form webform-submission-form form--inline clearfix test-form-properties js-webform-details-toggle webform-details-toggle" style="border: 10px solid green; padding: 1em;" data-drupal-selector="webform-submission-test-form-properties-add-form" action="' . $base_path . 'webform/test_form_properties" method="post" id="webform-submission-test-form-properties-add-form" accept-charset="UTF-8">');
  }
