...
class WebformWizardTest extends WebTestBase {
  ...
  public function testWizard() {
    ...
    $this->assertPattern('#<li class="webform-progress-bar__page webform-progress-bar__page--current">\s+<b>Your Feedback</b></li>#');
    // Check previous button does exist.
    $this->assertFieldById('edit-previous', '< Previous Page');
    ...
    $this->assertPattern('#<li class="webform-progress-bar__page webform-progress-bar__page--current">\s+<b>Preview</b></li>#');
    // Check progress pages.
    ...
    $this->assertPattern('#<li class="webform-progress-bar__page webform-progress-bar__page--current">\s+<b>Complete</b><span></span></li>#');
    // Check progress pages.
