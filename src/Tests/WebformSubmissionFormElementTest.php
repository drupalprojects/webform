...
class WebformSubmissionFormElementTest extends WebformTestBase {
  ...
  public function testElements() {
    ...
    $this->drupalLogin($this->adminFormUser);
    $edit = [
      'form_attributes__class[select][]' => ['form--inline clearfix', '_other_'],
      'form_attributes__class[other]' => 'test-form-properties',
      'form_attributes__style' => 'border: 10px solid green; padding: 1em;',
      'method' => '',
      'action' => '',
