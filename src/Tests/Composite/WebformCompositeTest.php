...
class WebformCompositeTest extends WebformTestBase {
  ...
  public function testComposite() {
    ...
    $this->assertRaw('<fieldset id="edit-contact-basic--wrapper" class="webform-contact--wrapper fieldgroup form-composite webform-composite-hidden-title required js-form-item form-item js-form-wrapper form-wrapper">');
