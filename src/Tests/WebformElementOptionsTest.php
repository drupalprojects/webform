...
webform_element_options_custom:
  ...
  three: Three");
    ...
    $this->assertRaw('<input data-drupal-selector="edit-webform-options-options-0-operations-add" formnovalidate="formnovalidate" type="image" id="edit-webform-options-options-0-operations-add" name="webform_options_table_add_0" src="' . $base_path . 'core/misc/icons/787878/plus.svg" class="image-button js-form-submit form-submit" />');
    $this->assertRaw('<input data-drupal-selector="edit-webform-options-options-0-operations-remove" formnovalidate="formnovalidate" type="image" id="edit-webform-options-options-0-operations-remove" name="webform_options_table_remove_0" src="' . $base_path . 'core/misc/icons/787878/ex.svg" class="image-button js-form-submit form-submit" />');
