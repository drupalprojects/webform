...
class WebformElementAddressTest extends WebformElementTestBase {
  ...
  public function testAddress() {
    ...
    $this->assertRaw('<span class="fieldset-legend">address_advanced<span class="webform-element-help" role="tooltip" tabindex="0" data-webform-help="This is help text"><span aria-hidden="true">?</span></span>');
