...
class WebformElementMultipleTest extends WebTestBase {
  ...
  - Three");
    ...
    $this->assertRaw('<td><input data-drupal-selector="edit-webform-multiple-default-items-0-operations-add" formnovalidate="formnovalidate" type="image" id="edit-webform-multiple-default-items-0-operations-add" name="webform_multiple_default_table_add_0" src="' . base_path() . drupal_get_path('module', 'webform') . '/images/icons/plus.svg" class="image-button js-form-submit form-submit" />');
    $this->assertRaw('<input data-drupal-selector="edit-webform-multiple-default-items-0-operations-remove" formnovalidate="formnovalidate" type="image" id="edit-webform-multiple-default-items-0-operations-remove" name="webform_multiple_default_table_remove_0" src="' . base_path() . drupal_get_path('module', 'webform') . '/images/icons/ex.svg" class="image-button js-form-submit form-submit" />');
