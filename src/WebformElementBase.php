...
class WebformElementBase extends PluginBase implements WebformElementInterface {
  ...
  public function prepare(array &$element, WebformSubmissionInterface $webform_submission) {
    ...
    WebformElementHelper::replaceTokens($element, $token_data, $token_options);
  }
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['webform']['description_display'] = [
      '#type' => 'select',
    ...
    $form['attributes']['wrapper_attributes__class'] = self::getAttributesClassElement(
      ...
      $this->configFactory->get('webform.settings')->get('elements.wrapper_classes')
    );
    ...
    $form['attributes']['attributes__class'] = self::getAttributesClassElement(
      ...
      $this->configFactory->get('webform.settings')->get('elements.classes')
    );
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    $default_properties = $this->getDefaultProperties();
    $this->properties = WebformElementHelper::removePrefix($this->configuration) + $default_properties;
    ...
    if (isset($this->properties['type'])) {
      $form['type'] = [
        '#type' => 'value',
        '#value' => preg_replace('/^webform_/', '', $this->properties['type']),
  ...
  public function getConfigurationFormProperties(array &$form, FormStateInterface $form_state) {
    ...
    // properties.
    WebformElementHelper::removePrefix($properties);
    ...
    $element = WebformElementHelper::addPrefix($properties);
    ...
    return WebformElementHelper::addPrefix($properties);
  }

  /**
   * Set configuration webform attributes from properties.
   *
   * @param array $properties
  ...
  /**
   * Get configuration webform attributes from properties.
   *
   * @param array $properties
   *   An array of element properties.
   */
